...
def create_kernel(
    ...
    *,
    ...
    ``strict_effect_contracts`` is opt-in for compatibility.  When enabled,
    process-originated SubmitAction syscalls must explicitly declare both
    ``side_effect_class`` and ``recovery_policy``.
    """
    ...
    dispatcher = SyscallDispatcher(
        ...
        lease_service,
        signal_service,
        strict_effect_contracts=strict_effect_contracts,
    )
