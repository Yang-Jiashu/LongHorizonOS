...
class TestRejectedPatchNoBump:
    ...
    def test_duplicate_edge_id_is_rejected_after_prior_edges(self, graph):
        """The O(1) edge-id index preserves duplicate-edge safety."""
        ...
        assert exc_info.value.code == VPGCode.EDGE_ALREADY_EXISTS
